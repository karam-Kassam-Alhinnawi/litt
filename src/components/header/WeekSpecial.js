...
const card = [
    ...
    {img: cardImgTwo, name:'Bruschetta', price: '30.99', desc: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione totam magnam nihil dignissimos id fugit, omnis ad aperiam harum magni!'},
...
const WeekSpecial = () => {
  return (
    <div className="week-special" style={{marginTop: '120px'}}>
      ...
      {card.map((detail) => (
        <div className="card">
            ...
            <p style={{color:'rgb(29% 37% 34%)'}}>{detail.desc}</p>
